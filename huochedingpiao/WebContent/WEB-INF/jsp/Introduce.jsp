	...
	<div class="formbody">
		...
		<div id="usual1" class="usual">
			...
			<div id="tab1" class="tabson">
				...
				<form action="introduce/informationUpdate" method="POST"
					onsubmit="return checkSubmit();">
					<input type="hidden" name="id" value="1">
					<ul class="forminfo">
						<li>网站简介<label><b>*</b></label><textarea name="text" id="content7" class="dfinput"
								style="width: 518px;">${introduce['text'] }</textarea></li>
