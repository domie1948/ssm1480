	...
	<div class="formbody">
		...
		<div id="usual1" class="usual">
			...
			<div id="tab1" class="tabson">
				...
				<form action="message/informationUpdate" method="POST"
					onsubmit="return checkSubmit();">
					<input type="hidden" name="id" value="${message['id'] }">
					<input type="hidden" name="reply_id" value="${sessionScope['Admin']['id'] }">
					<ul class="forminfo">
						<li><label>留言信息<b>*</b></label><textarea  id="content7" class="dfinput"
								style="width: 518px;">${message['message'] }</textarea></li>
						<li><label>回复信息<b>*</b></label><textarea name="reply_message" id="content6" class="dfinput"
								style="width: 518px;">${message['reply_message'] }</textarea></li>
						<li><label>&nbsp;</label><input name="" type="submit"
							class="btn" value="回复信息" /></li>
					</ul>
