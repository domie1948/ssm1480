				...
				<form action="user/userUpdate" method="POST"
					...
					<ul class="forminfo">
						<li><label>登录名<b>*</b></label><input id="loginName"
							value="${user['loginName']}" name="loginName" type="text"
							class="dfinput" placeholder="请填写登录名" style="width: 518px;" /></li>
						<li><label>用户姓名<b>*</b></label><input id="userName"
							value="${user['userName']}" name="userName" type="text"
							class="dfinput" placeholder="请填写用户姓名" style="width: 518px;" /></li>
						<li><label>电话<b>*</b></label><input id="phone"
							value="${user['phoneNo']}" name="phoneNo" type="text" class="dfinput"
							placeholder="请填写电话" style="width: 518px;" /></li>
						<li><label>角色<b>*</b></label><div class="vocation">
