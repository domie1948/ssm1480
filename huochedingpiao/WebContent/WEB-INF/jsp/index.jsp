...
<body>
    ...
    if(d.getHours()>=18||d.getHours()<4){document.write("晚上好!")}
       ...
       document.write(d.getFullYear()+"."+(d.getMonth()+1)+"."+d.getDate())
				...
				href="user/queryOne?id=${sessionScope['Admin']['id'] }">帐号设置</a>&nbsp;
				 <a
				href="request/passUpdate?id=${sessionScope['Admin']['id'] }">修改密码</a>
				<br />
		</div>
		<div class="xline"></div>
		...
		<%--<ul class="iconlist">
			...
			<p>
					<a
						href="sys/plan/informationLoad?admin=${sessionScope['User']['userName']}">员工管理</a>
				</p></li>
			...
			<p>
					<a
						href="sys/notice/informationLoad?admin=${sessionScope['User']['userName']} ">公司公告</a>
				</p></li>
