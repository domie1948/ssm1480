...
<form id="jobform" method="post" action="custom/informationUpdate" name="jobform">
<table width="100%" border="0" cellspacing="0" cellpadding="3" >
<tr> 
      <td width="80" align="right">乘客姓名：</td>
      <td> 
        <input type="text" name="name" value="${custom['name'] }" class="input" style="width:200px" />
        <font style='color:red'>*</font> <div style="padding-top:3px;color:#666"></div>  </td>
    </tr>

     <tr> 
      <td width="80" align="right">乘客年龄：</td>
      <td> 
        <input type="text" name="age" value="${custom['age'] }" class="input" style="width:200px" />
        <font style='color:red'>*</font> <div style="padding-top:3px;color:#666"></div> </td>
    </tr>


	<tr> 
      <td width="80" align="right">乘客性别：</td>
      <td> 
        <select name="sex">
        		<c:if test="${custom['sex'] eq 1}" var="s1">
        			<option value="1" selected="selected">男</option>
        		</c:if>
        		<c:if test="${!s1}">
        			<option value="1">男</option>
        		</c:if>
        		<c:if test="${custom['sex'] eq 2}" var="s2">
	...
	<tr> 
      ...
      <td> 
       <input type="text" name="id_card" value="${custom['id_card'] }" class="input" style="width:200px" />
        <font style='color:red'>*</font> <div style="padding-top:3px;color:#666"></div> </td>
    </tr>
	<tr> 
