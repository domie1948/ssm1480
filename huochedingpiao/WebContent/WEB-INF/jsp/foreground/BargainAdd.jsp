...
<form id="jobform" method="post" action="bargain/informationAddFore" name="jobform">
<table width="100%" border="0" cellspacing="0" cellpadding="3" >

<tr> 
      <td width="80" align="right">乘客信息：</td>
      <td> 
    ...
    <tr> 
      ...
      <td height="30">
        ...
        <input type='hidden' name='information_id' value="${informationId}">
	  </td>
    </tr>
  </table>
</form>
