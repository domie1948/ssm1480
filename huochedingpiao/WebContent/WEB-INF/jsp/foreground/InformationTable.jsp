...
<table width="100%" border="0" cellpadding="3" cellspacing="0" class="shopcart">
		  ...
		  <c:forEach items="${pager.datas }" var="information" varStatus="vs">
                <tr >
	                <td>&nbsp; </td>
	                <td>${information['number'] }</td>
	                <td>${information['name'] }</td>
	                <td>${information['start'] }</td>
	                <td>${information['end'] }</td>
	                <td>${information['start_time'] }</td>
	                <td>${information['end_time'] }</td>
	                <td>${information['price'] }</td>
	                <td><a href="request/bargainAdd?informationId=${information['id'] }">订票</a></td>
                </tr>
 			 </c:forEach>
</table>
