...
<form id="jobform" method="post" onsubmit="return Check();" action="user/userUpdateF" name="jobform">
<table width="100%" border="0" cellspacing="0" cellpadding="3" >
    ...
    <tr> 
      ...
      <td> 
        <input type="text" name="loginPassword" id="loginPassword" class="input" style="width:200px" />
     ...
     <tr> 
      ...
      <td> 
        <input type="text" name="identify" id="identify" class="input" style="width:200px" />
        <font style='color:red'>*</font> <div style="padding-top:3px;color:#666"></div> </td>
    </tr>
