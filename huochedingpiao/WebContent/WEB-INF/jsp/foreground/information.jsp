...
<form id="jobform" method="post" action="user/userUpdateF" name="jobform">
<table width="100%" border="0" cellspacing="0" cellpadding="3" >

<tr> 
      <td width="80" align="right">用 户 名：</td>
      <td> 
        <input type="text" name="loginName" value="${user['loginName'] }" class="input" style="width:200px" />
     ...
     <tr> 
      ...
      <td> 
        <input type="text" name="userName" value="${user['userName'] }" class="input" style="width:200px" />
        <font style='color:red'>*</font> <div style="padding-top:3px;color:#666"></div> </td>
    </tr>
	...
	<tr> 
      ...
      <td> 
        <input type="text" name="selfId" value="${user['selfId'] }" class="input" style="width:200px" />
        <font style='color:red'>*</font> <div style="padding-top:3px;color:#666"></div>  </td>
    </tr>
	...
	<tr> 
      ...
      <td> 
       <input type="text" name="phoneNo" value="${user['phoneNo'] }" class="input" style="width:200px" />
        <font style='color:red'>*</font> <div style="padding-top:3px;color:#666"></div> </td>
    </tr>
	<tr> 
