...
<form id="jobform" method="post" action="custom/informationAdd" name="jobform">
<table width="100%" border="0" cellspacing="0" cellpadding="3" >

<tr> 
      <td width="80" align="right">乘客姓名：</td>
      <td> 
        <input type="text" name="name" class="input" style="width:200px" />
     ...
     <tr> 
      ...
      <td> 
        <input type="text" name="age" class="input" style="width:200px" />
        <font style='color:red'>*</font> <div style="padding-top:3px;color:#666"></div> </td>
    </tr>
	...
	<tr> 
      ...
      <td> 
       <input type="text" name="id_card" class="input" style="width:200px" />
        <font style='color:red'>*</font> <div style="padding-top:3px;color:#666"></div> </td>
    </tr>
	<tr> 
