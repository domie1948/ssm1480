	...
	<div class="formbody">
		...
		<div id="usual1" class="usual">
			...
			<div id="tab1" class="tabson">
				...
				<form action="function/functionUpdate" method="POST"
					onsubmit="return checkSubmit();">
					<input type="hidden" name="id" value="${function['id']}">
					<ul class="forminfo">
						<li><label>标题<b>*</b></label><input id="title" value="${function['title']}"
							name="title" type="text" class="dfinput" placeholder="请填写名称"
							style="width: 518px;" /></li>
						<li><label>名称<b>*</b></label><input id="name" value="${function['name']}"
							name="name" type="text" class="dfinput" placeholder="请填写标题"
							style="width: 518px;" /></li>
						<li><label>地址<b>*</b></label><input id="url" value="${function['url']}"
